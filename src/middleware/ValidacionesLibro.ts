...
export function validacionCrearLibro(req:Request, res:Response, next:NextFunction) {
    ...
    try {
        ...
        let mensajeNombreLibro = HttpStatusWords.DATO_REQUERIDO_NOMBRE_LIBRO
        ...
        let mensajeAutorLibro = HttpStatusWords.DATO_REQUERIDO_AUTOR_LIBRO;
        ...
        let mensajeAutorNumerico = HttpStatusWords.DATO_INVALIDO_AUTOR_NUMERO;
        ...
        let mensajeCopiasLibro = HttpStatusWords.DATO_REQUERIDO_COPIAS_LIBRO;
        let statusCodeCopiaNoNumero = HttpStatusCode.DATO_INVALIDO;
        let mensajeCopiaNumerico = HttpStatusWords.DATO_INVALIDO_CANTIDAD_NUMERO;
        ...
        let mensajeCantCopias = HttpStatusWords.DATO_INVALIDO_CANTIDAD_DISPONIBLE;
...
export function validacionIdLibro(req:Request, res:Response, next:NextFunction) {
    ...
    try {
        ...
        let mensajeIdLibro = HttpStatusWords.DATO_REQUERIDO_ID_LIBRO;
        ValidadorErrores.validarDatoRequerido(idLibro, statusCodeIdLibro, mensajeIdLibro);

        let statusCodeDatoNumerico = HttpStatusCode.DATO_INVALIDO;
        let mensajeIdNumerico = HttpStatusWords.DATO_INVALIDO_ID_LIBRO;
